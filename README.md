...
一个 **Windows 桌面实时股价监控悬浮窗**:输入股票代码或名称,实时显示股价与分时走势,内置 KDJ / MACD / RSI / BOLL / WR / BIAS 等专业指标,支持条件提醒(全屏红光闪烁)。纯绿色单文件,双击即用,无需安装。
...
```
StockMonitor.cs        # 数据源 + 指标计算 + 配置 + 提醒引擎
StockMonitor.UI.cs     # 悬浮窗 / 配置窗口 / 捐赠窗口 / 主程序
